    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-0 shadow">
                <div class="card-header pl-4 font-weight-bold">{{ __('Login') }}</div>
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check custom-control custom-radio">
                                    ...
                                    <label class="form-check-label custom-control-label font-weight-bold" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link text-muted font-weight-bold" href="{{ route('password.request') }}">
